-- DDL + DML for Layer 3 dialect extract / remote-body tests.
-- Aligned with e2e/fixtures/alloydb.sql type_matrix (and a small orders smoke table).
...
INSERT INTO public.orders (id, user_uuid, payload, amount, created_at) VALUES
  (1, '11111111-1111-1111-1111-111111111111', '{"source":"dialect","active":true}', 12.34, '2026-01-02 03:04:05'),
  (2, '22222222-2222-2222-2222-222222222222', '{"source":"dialect","active":false}', 56.78, '2026-02-03 04:05:06');
